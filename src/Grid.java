...
public class Grid {
    ...
    public void readDimensions(Scanner sc) {
        ...
        String[] dimensions = numbers.split(",");
    ...
    public Coordinate searchRight(int row, int col, String word) {
        ...
        Coordinate endLetter = new Coordinate(row, col);

        if (col + word.length() > (width - 1))
            return null;

        for (int i = 0; i < word.length(); i++) {
            char currentLetter = grid[row][col + i];
            char currentWordLetter = word.charAt(i);
            if (currentLetter != currentWordLetter) {

                return null;

            } else {
                endLetter = new Coordinate(row, col + i);
    ...
    public Coordinate searchDown(int row, int col, String word) {
        ...
        for (int i = 0; i < word.length(); i++) {
            ...
            char currentLetter = grid[row + i][col];
            char currentWordLetter = word.charAt(i);
            if (currentLetter != currentWordLetter) {
                ...
                endLetter = new Coordinate(row + i, col);
    ...
    public Coordinate searchDownRight(int row, int col, String word) {
        ...
        for (int i = 0; i < word.length(); i++) {
            ...
            char currentLetter = grid[row + i][col + i];
            char currentWordLetter = word.charAt(i);
            if (currentLetter != currentWordLetter) {
                ...
                endLetter = new Coordinate(row + i, col + i);
    ...
    public Coordinate searchDownLeft(int row, int col, String word) {
      Coordinate endLetter = new Coordinate(row, col);
        ...
        if (row + word.length() > (height) || col - word.length() < 0){
    ...
    public Coordinate searchUpRight(int row, int col, String word) {
        ...
        if (row - word.length() < (0) || col + word.length() > width - 1){
    ...
    public Coordinate searchUpLeft(int row, int col, String word) {
      ...
      Coordinate endLetter = new Coordinate(row, col);
        ...
        if (row - word.length() < (0) || col - word.length() <  -1){
